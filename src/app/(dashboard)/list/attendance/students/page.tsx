    ...
    <BarChart data={absenceHeatmapData}>
      ...
      <div>
        ...
        <div className="bg-gradient-to-r from-[#1e40af] to-[#3b82f6] py-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 px-6">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 flex items-center justify-center">
                <Activity className="w-5 h-5 text-white" />
              </div>
                        ...
                        <div className="p-6 overflow-auto max-h-[calc(90vh-140px)]">
                          ...
                          <div className="flex flex-col gap-4 mb-6">
                            ...
                            {drillDownPath.length > 0 && (
                              <div className="flex items-center gap-2 text-xs bg-blue-50 p-3 rounded-xl border border-blue-200">
                                <button
                          ...
                          <div className="mt-6 pt-4 border-t border-gray-200 bg-gray-50 rounded-xl p-4">
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                              ...
                              <div className="flex items-center gap-3">
                                <button className="text-sm text-blue-600 hover:text-blue-800 bg-blue-100 hover:bg-blue-200 px-3 py-2 rounded-xl transition-all flex items-center gap-2">
                                  <Download className="w-4 h-4" />
                                  Export Data
                                </button>
                                <button className="text-sm text-orange-600 hover:text-orange-800 bg-orange-100 hover:bg-orange-200 px-3 py-2 rounded-xl transition-all flex items-center gap-2">
                                  <Bell className="w-4 h-4" />
                                  Send Alerts
                                </button>
                                <button className="text-sm text-green-600 hover:text-green-800 bg-green-100 hover:bg-green-200 px-3 py-2 rounded-xl transition-all flex items-center gap-2">
